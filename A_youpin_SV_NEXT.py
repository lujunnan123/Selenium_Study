...
class Youpin:
    def __init__(self, root):
        ...
        del_btn = tk.Button(
            ...
            font=("微软雅黑", 12, "bold"),
            relief=tk.FLAT,
            command=lambda:self.del_task('三角洲行动')
        )
        ...
        up_btn = tk.Button(
            ...
            font=("微软雅黑", 12, "bold"),
            relief=tk.FLAT,
            command=lambda:self.up_task('三角洲行动')
        )
        ...
        wdel_btn = tk.Button(
            ...
            font=("微软雅黑", 12, "bold"),
            relief=tk.FLAT,
            command=lambda:self.wdel_task('无畏契约')
        )
        ...
        wup_btn = tk.Button(
            ...
            font=("微软雅黑", 12, "bold"),
            relief=tk.FLAT,
            command=lambda:self.wup_task('无畏契约')
        )
    ...
    def del_task(self,name):
        if self.is_running:
            ...
            return
        task_thread = threading.Thread(target=self.delhandle,args=(name,), daemon=True)
        task_thread.start()
        self.is_running = True

    def up_task(self,name):
        if self.is_running:
